...
using MelonLoader;
using System.IO;
[assembly: MelonInfo(typeof(BTD6_Energising_Totem_In_Shop.Class1), "Energising Totem In Shop", "1.1.0", "kenx00x")]
...
namespace BTD6_Energising_Totem_In_Shop
{
    public class Class1 : MelonMod
    {
        ...
        {
            MelonLogger.Log("Energising Totem In Shop mod loaded");
        ...
        public class ProfileModel_Patch
        {
            ...
            public static void Postfix(ProfileModel __instance)
            {
                ...
                {
                    MelonLogger.Log("Energising Totem already unlocked");
                }
                else
                {
                    MelonLogger.Log("unlocking Energising Totem");
